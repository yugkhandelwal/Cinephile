        ...
        <div className="flex overflow-x-auto gap-6 pl-6 md:pl-12 lg:pl-16 scroll-pl-6 md:scroll-pl-12 lg:scroll-pl-16 pr-6 pb-8 pt-4 snap-x snap-mandatory hide-scrollbar">
          {children && Array.isArray(children) 
            ? children.map((child, i) => (
                <div key={i} className="flex-none w-[180px] sm:w-[220px] md:w-[260px] lg:w-[280px] snap-start">
                  {child}
                </div>
              ))
            : <div className="flex-none w-[180px] sm:w-[220px] md:w-[260px] lg:w-[280px] snap-start">{children}</div>}
        </div>
